...
Route::put('menu/update_menu/{id}', [MenuItemController::class,'update_menu'])->name('menu.update_menu');
...
Route::get('/', [IndexController::class, 'header_menu'])->name('header.header_menu');
